...
public class frmKardex extends javax.swing.JInternalFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtBuscarCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(btnMostrarMovimientos, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void btnMostrarMovimientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarMovimientosActionPerformed
        ...
        listarKardexSalidas(productoID, obtenerFechaDesde(),obtenerFechaHasta());
        
        listarKardexEntradas(productoID, obtenerFechaDesde(), obtenerFechaHasta());
    }//GEN-LAST:event_btnMostrarMovimientosActionPerformed

    private void btnBuscarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarProductoActionPerformed
        if(txtBuscarCodigo.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Campo Vacio.", "ALERTA", JOptionPane.WARNING_MESSAGE);
        }else{
            buscarProductoXCodigo(txtBuscarCodigo.getText());
        }
    ...
    private void buscarProductoXCodigo(String codigo){
        Producto objProducto = new Producto();
        
        objProducto= ProductoBL.getInstance().searchByCodigo(codigo);
        if(objProducto!=null){
            productoID=objProducto.getIdProducto();
            txtCodigoProducto.setText(objProducto.getCodigo());
            txtNombreProducto.setText(objProducto.getNombre());
            txtStock.setText(Integer.toString(objProducto.getStock()));
        }else{
